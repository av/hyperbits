...
import { interpolateColorKeyframes, colorProxy } from "../color";
...
describe("colorProxy", () => {
  it("applies interpolated color onto an element via gsap.to", () => {
    const element = document.createElement("div");
    const { proxy, apply } = colorProxy(element, ["#ff0000", "#0000ff"]);
